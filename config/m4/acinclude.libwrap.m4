...
[
	libwrap_error="no"
	check_libwrap="gen libc io cuda cudart"
	force_libwrap="no"
	have_libwrap="no"
	...
	AC_ARG_ENABLE(libtrace,
		AC_HELP_STRING([--enable-libtrace=LIST],
			[enable library tracing support (gen,libc,io,cuda,cudart), default: automatically by configure]),
	[
