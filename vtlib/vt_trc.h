 ...
 *               (VT_MPI_COMM_WORLD, VT_MPI_COMM_SELF, or VT_MPI_COMM_USER)
...
EXTERN int vt_num_traces; /** number of processes/MPI-ranks */
EXTERN int vt_my_trace;   /** current process/MPI-rank id */
EXTERN int vt_my_ptrace;  /** parent process id */
EXTERN uint8_t vt_my_trace_is_master; /** 1st MPI-rank on local node? */
EXTERN uint8_t vt_my_trace_is_disabled; /** MPI-rank disabled? */
